  ...
  return (
    <section className="bg-dark-blue flex items-center flex-col text-center w-[100%] p-3">
      ...
      <p className="pb-10 w-[80%] ">
        ...
        excessively, resulting in increased productivity even when faced with
        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div className="p-5">
            ...
            <p className="mb-3 font-normal text-black dark:text-gray-400">
              nameOfTheApp is designed for improving time management skills for
              individuals and assisting teachers in supporting students with
          ...
          <Link to="/">
            <button
              type="button"
              className="focus:outline-none text-white bg-orange hover:bg-dark-orange focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900"
            >
              Learn More
            </button>
          </Link>
